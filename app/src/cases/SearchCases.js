    ...
    <Row>
      <Col>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <legend>{translation.t("SEARCH_HELP_TEXT")}</legend>
          ...
          <FormGroup>
            <Label htmlFor="dateOfBirth">
              {translation.t("DATE_OF_BIRTH_INPUT")}
            </Label>
            <Field name="dateOfBirth" component={InputField} type="date" />
            <FormText color="muted">{translation.t("DOB_HELP")}</FormText>
          </FormGroup>
          <Button className="mb-3" color="danger" size="sm">
            {translation.t("SUBMIT_SEARCH_BUTTON")}
          </Button>
        </Form>
      </Col>
    </Row>
...
class SearchCasesContainer extends React.Component {
  ...
  render() {
    return <SearchCases {...this.props} onSubmit={this.handleSearchSubmit} />;
  }
}
